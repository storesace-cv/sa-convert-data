...
SCHEMA_FILE_PATH = Path(__file__).resolve().parents[2] / "databases" / "app" / "schema.sql"
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_pair_judgement_scope_terms ON pair_judgement(scope, left_term_norm, right_term_norm, label);
"""
